        ...
        return (
            <div className="Header">
                <div className="col-md-6">
                    ...
                    <a href="ExploreService"><button type="button" className="btn btn-lg btn-started">Explore</button></a>
                    <a><button type="button" className="btn btn-lg btn-outline-schedule Hbutton">Schedule a demo</button></a>
                </div>
                <div className="col-md-6">
                    <div className="Himg">
                        <img src="" alt=""/>
